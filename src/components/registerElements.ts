// Register the Wokwi custom elements used by the component catalog.
//
// When adding a Wokwi-backed component, add exactly one import here and its
// metadata in parts.ts. Static SVG/Fritzing parts do not need registration.
...
import '@wokwi/elements/dist/esm/ky-040-element.js';
...
import '@wokwi/elements/dist/esm/stepper-motor-element.js';
import '@wokwi/elements/dist/esm/tilt-switch-element.js';
import '@wokwi/elements/dist/esm/big-sound-sensor-element.js';
...
import '@wokwi/elements/dist/esm/ir-receiver-element.js';
import '@wokwi/elements/dist/esm/ir-remote-element.js';

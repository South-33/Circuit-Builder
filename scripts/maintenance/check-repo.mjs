...
const required = [
  ...
  'docs/research/harness-experiments.md',
  ...
  'src/agent/webmcp.ts',
  'src/agent/types.ts',
  'src/agent/core/grid.ts',
  'src/agent/core/layout.ts',
  'src/agent/core/router.ts',
  'src/agent/core/session.ts',
  'src/agent/profiles/index.ts',
  'src/agent/profiles/legacy.ts',
  'src/agent/profiles/procedural.ts',
  'src/agent/profiles/blueprint.ts',
  'src/agent/profiles/semantic.ts',
  'scripts/testing/test-circuits.mjs',
  'scripts/testing/loader.mjs',
  'scripts/benchmarks/harness-comparison.mjs',
...
const expectedScripts = {
  ...
  'benchmark:harnesses': 'node scripts/benchmarks/harness-comparison.mjs',
};

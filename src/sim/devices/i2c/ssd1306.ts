 ...
 */
import type { I2CDevice } from './bus';
...
export class SSD1306Controller implements I2CDevice {
  ...
  private scroll() {
    // Scroll advances when the controller is stepped; the SSD1306 clock
    // divisor itself is intentionally outside this small display model.
